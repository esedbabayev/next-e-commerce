  ...
  return (
    <div className='inline-block'>
      ...
      <div className='flex items-center gap-[5px]'>
        { <h3 className='text-[20px] font-bold lg:text-[24px]'>${(discountedPrice.toFixed(2))}</h3>}

        {discountPrice !== 0 &&  <span className=' text-[#00000066] text-[20px] font-bold line-through'>${newArrival?.price}</span>}

        {discountPrice !== 0 && <span className='text-[#FF3333] text-[10px] font-medium 
